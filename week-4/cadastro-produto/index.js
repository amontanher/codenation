...
function App(){
    ...
    }, [])//isso é para rodar apenas uma vez
    ...
    const inputs = [
        {name: "produto", value: produto, onChange: handleProduto, type: "text", label: "Produto"},
        {name: "valor", value: valor, onChange: handleValor, type: "text", label: "Valor"}
    ];
    ...
    return(
        <Container>
            ...
            <section>
                ...
                <Table head={head} rows={produtos} onClickDeleteAll={handleClickDeleteAll}/>
            </section>
        </Container>
    )
}
